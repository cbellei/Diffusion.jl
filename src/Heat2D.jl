...
function main()
    ...
    if (my_id == root)
        params_int, params_double = get_sim_params()
    end
    ...
    if (my_id==0)
        time_init = time()
#         println("size_global_x = ", size_global_x)
#         println("size_global_y = ", size_global_y)
#         println("size_total_x = ", size_total_x)
#         println("size_total_y = ", size_total_y)
#         println(xs, " ", xe)
#         println(ys, " ", ye)
    end
    ...
    if (my_id == 0)
        write_to_disk(xfinal[:], nx_domains, ny_domains, xcell, ycell)
    end
